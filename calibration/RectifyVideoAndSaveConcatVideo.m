...
s1 = 'C:\Users\michael kadosh\Desktop\VIDEO';%%% המיקום שבו נמצאים סרטוני הווידאו מתוך המערכת 
s2 = '\';
%% Insert calibration files path
s3 = 'C:\Users\michael kadosh\Desktop\תואר שני\תזה\קטעי וידאו ותמונות מתוך המערכת\12.5.2022\calibration';%% The location of the calibrsation files: tform,cameraParams,CameraOffsetPixOnPlane
